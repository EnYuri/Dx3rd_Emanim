// Archived AppV1 Vehicle item sheet
(function() {
...
class DX3rdVehicleSheet extends window.DX3rdItemSheet {
  ...
  async getData(options) {
    ...
    // 액터 스킬 데이터 추가
    itemSheetData.prepareSkillOptions(item, data, 'vehicle', {warnIfMissing: true});
  ...
  activateListeners(html) {
    ...
    itemSheetData.activateEquipmentListener(this, root, {logPrefix: 'VehicleSheet'});
    itemSheetData.activateSystemFieldListeners(this, root, {
      logPrefix: 'VehicleSheet',
