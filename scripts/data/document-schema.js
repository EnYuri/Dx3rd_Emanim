  ...
  const DEFAULTS = {
    ...
    Item: {
      ...
      effect: {
        ...
        effect: { disable: 'notCheck', runTiming: 'instant', action: '', stack: false, attributes: {} },
        active: { state: false, disable: '-', runTiming: 'instant', action: '', applyMode: 'onUse', stack: false },
      ...
      weapon: {
        ...
        range: '',
        equipment: false,
        active: { state: false, disable: '-', runTiming: 'instant', action: '', applyMode: 'toggle', stack: false },
        used: { state: 0, max: 0, level: false, disable: 'notCheck' },
      ...
      connection: {
        templates: ['base', 'item'],
        skill: '-',
        active: { state: false, disable: '-', runTiming: 'instant', stack: false },
        attributes: {},
        getTarget: false,
        effect: { disable: 'notCheck', runTiming: 'instant', stack: false, attributes: {} },
